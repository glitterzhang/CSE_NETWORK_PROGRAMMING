...
///?
  ...
  ef->SetAttribute ("ErrorRate", DoubleValue (BC_BER)); //0.00005
...
//  ns3TcpSocket->TraceConnectWithoutContext ("CongestionWindow", MakeCallback (&CwndChange));//CREATE SOCKET
  ...
  app->SetStopTime (Seconds (20.));
    ...
    Ptr<OutputStreamWrapper> stream = asciiTraceHelper.CreateFileStream ("tcpchain1.cwnd");
  ...
  pointToPoint.EnableAsciiAll (ascii.CreateFileStream ("tcpchain.tr"));
